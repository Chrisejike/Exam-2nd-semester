...
# Configure MYSQL with username and password.
...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=chris/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=chris/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=chrisejike09/' /var/www/html/laravel/.env
